...
EXEC sp_helprotect @username  = 'REGISTRAR\dmorada';
EXEC sp_helprotect @username  = 'UCLANET\dmorada';
...
and USER_NAME(grantee_principal_id) in ('REGISTRAR\dmorada','UCLANET\dmorada')
AND minor_id = 0; 
